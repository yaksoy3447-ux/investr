...
// Also inject Pricing just in case
trData.pricing = {
  title: "Esnek Fiyatlandırma",
  subtitle: "Startuplar için en güçlü veritabanı. İhtiyacınıza uygun planı seçin.",
  tier1: {
    name: "Standard", desc: "Aylık hafif araştırmalar için", price: "99", btn: "Hemen Başla",
    features: { f1: "Aylık Sınırsız Arama", f2: "Detaylı Filtreleme", f3: "500 Kişi İndirme", f4: "Önceliksiz Destek"}
  },
  tier2: {
    badge: "ÖNERİLEN",
    name: "Pro", desc: "Yoğun tur arayışındaki ekipler", price: "249", btn: "Pro'ya Yükselt",
    features: { f1: "Aylık Sınırsız Arama", f2: "Çok Gizli E-postalar", f3: "Ayda 2.000 Kişi İndirme", f4: "Toplu İşlemler", f5: "Erken Bildirimler", f6: "Öncelikli Destek"}
  },
  tier3: {
    name: "Enterprise", desc: "Büyük ölçekli fonlar için", price: "990", btn: "Bizimle Göruşün",
    features: { f1: "Sınırsız Özellikler", f2: "API Erişimi", f3: "Ekip Kullanımı", f4: "Özel Müşteri Temsilcisi"}
  }
};

enData.pricing = {
  title: "Transparent Pricing",
  subtitle: "The most powerful database for startups. Choose the plan right for your stage.",
  tier1: {
    name: "Standard", desc: "For light monthly research", price: "99", btn: "Get Started",
    features: { f1: "Unlimited Monthly Searches", f2: "Detailed Filtering", f3: "500 Exports/mo", f4: "Standard Support"}
  },
  tier2: {
    badge: "MOST POPULAR",
    name: "Pro", desc: "For teams actively raising", price: "249", btn: "Upgrade to Pro",
    features: { f1: "Unlimited Monthly Searches", f2: "Unlock Secret Emails", f3: "2,000 Exports/mo", f4: "Bulk Select Actions", f5: "Early Notifications", f6: "Priority Support"}
  },
  tier3: {
    name: "Enterprise", desc: "For high volume scaling", price: "990", btn: "Contact Us",
    features: { f1: "Unlimited Features", f2: "API Access", f3: "Team Sharing", f4: "Dedicated Rep"}
  }
};

fs.writeFileSync(trPath, JSON.stringify(trData, null, 2), 'utf8');
fs.writeFileSync(enPath, JSON.stringify(enData, null, 2), 'utf8');
console.log('Finished injecting all missing language keys + premium texts!');
