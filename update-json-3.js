...
tr.landing.faq = {
  ...
  a4: "Yıllık abonelik seçtiğinizde, 12 aylık kullanım bedeli yerine yalnızca 9 aylık ücret ödersiniz. Böylece faturanızda 3 aylık bir indirim uygulanmış olur. Seçtiğiniz pakete tanımlı olan krediler, her ay düzenli olarak hesabınıza yüklenmeye devam eder.",
...
en.landing.faq = {
  ...
  a4: "When you choose a yearly subscription, you pay for only 9 months of usage instead of 12. This effectively applies a 3-month discount to your billing total. The credits included in your chosen plan will continue to be refilled into your account every month.",
