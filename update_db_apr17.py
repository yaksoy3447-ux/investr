...
import shutil
import os
from data_tr_apr17 import posts_tr_apr17
from data_en_apr17 import posts_en_apr17
...
def merge_and_update(file_path_tr, file_path_en):
    ...
    for p in reversed(posts_tr_apr17):
        max_id_tr += 1
        p['id'] = max_id_tr
    ...
    for p in reversed(posts_en_apr17):
        max_id_en += 1
        p['id'] = max_id_en
...
names = ["openfx", "modus_ai", "artemis_ai", "solidroad_ai", "spektr_ai"]
...
print("JSON databases successfully updated and image placeholders created.")
