...
tr.pages = {
  ...
  aboutContent: "GetInvestr, girişimciler ile melek yatırımcılar, risk sermayeleri ve kurumsal yatırımcılar arasında köprü kurmayı hedefleyen yenilikçi bir finansal teknoloji platformudur.\n\nAmacımız, aylarca süren yatırım arayışı süreçlerini minimize ederek, doğru eşleşmeleri en hızlı ve en güvenilir yoldan sağlamaktır. Teknolojimizi tutkuyla geliştiriyor, girişim ekosistemini güçlendirmeye devam ediyoruz.",
  contactTitle: "İletişim",
  contactContent: "Bizimle iletişime geçmekten çekinmeyin! Herhangi bir sorunuz veya öneriniz için aşağıdaki kanallar üzerinden bize ulaşabilirsiniz:\n\nE-posta: iletisim@getinvestr.com\nTelefon: +90 (212) 555 55 55\n\nMüşteri hizmetleri ekibimiz sizlere en kısa sürede dönüş yapacaktır.",
  careersTitle: "Kariyer",
  careersContent: "Açık bir kariyer vizyonu ve inovasyon tutkusuyla çalışıyoruz.\n\nŞu anda aktif bir açık pozisyonumuz bulunmamaktadır. Ancak ekibimize dahil olmak veya gelecekteki fırsatlar için değerlendirilmek isterseniz özgeçmişinizi kariyer@getinvestr.com adresine gönderebilirsiniz. Sizi tanımaktan mutluluk duyarız!",
  termsTitle: "Kullanım Koşulları",
  termsContent: "Bu platformu kullanarak, GetInvestr'ın tüm kurallarını okumuş ve kabul etmiş sayılırsınız.\n\nSisteme kayıtlı kullanıcılarımız doğru bilgi verdiklerini taahhüt ederler. İçerik doğrulukları ve sağlanan materyaller kendi sorumluluğunuzdadır.\n\nÖnemli Hatırlatma: Yatırımcıların size dönüş yapıp yapmayacağı kesinlikle yatırımcının kendisine aittir. Yatırımcı dönüş yapmazsa kesinlikle bunun sorumluluğu GetInvestr ailesine ait değildir.\n\nKullanım koşulları her zaman değiştirilebilir olup, güncel metin her daim bu sayfadan duyurulacaktır.",
...
en.pages = {
  aboutTitle: "About Us",
  aboutContent: "GetInvestr is an innovative financial technology platform aiming to bridge the gap between startup founders, angel investors, venture capitalists, and corporate investors.\n\nOur objective is to dramatically minimize the months-long investment sourcing process, enabling the fastest and most secure direct matchmaking. We build our technology with passion, continuing to empower the startup ecosystem universally.",
  contactTitle: "Contact",
  contactContent: "Do not hesitate to reach out! For any questions or suggestions, please contact us through the following channels:\n\nEmail: contact@getinvestr.com\nPhone: +90 (212) 555 55 55\n\nOur customer operations team will get back to you immediately.",
  careersTitle: "Careers",
  careersContent: "We operate with a transparent career vision and a hunger for innovation.\n\nWe do not have any open positions at the moment. However, if you would like to join our vibrant team or be considered for future opportunities, please forward your resume to careers@getinvestr.com. We'd love to meet you!",
  termsTitle: "Terms of Service",
  termsContent: "By utilizing this platform, you acknowledge and agree to abide by all rulings of GetInvestr.\n\nRegistered users commit to maintaining accurate information securely. Content validation and materials provided are your own responsibility.\n\nImportant Reminder: Whether an investor decides to respond to your communication is entirely up to the investor themselves. GetInvestr assumes no responsibility or liability if an investor does not respond to your outreach.\n\nWe reserve the full rights to alter our global terms at any moment here exclusively.",
